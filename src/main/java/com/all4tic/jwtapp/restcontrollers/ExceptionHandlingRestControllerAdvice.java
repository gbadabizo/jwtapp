...
public class ExceptionHandlingRestControllerAdvice  implements ErrorController {
  ...
  /*  @ExceptionHandler(NoHandlerFoundException.class)
    public ResponseEntity<HttpResponse> methodNotSuportedException(NoHandlerFoundException exception) {
